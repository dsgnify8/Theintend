...
import { buyProgram, restorePrograms, useOwnedPrograms } from '@/lib/programs';
import { priceFor } from '@/lib/iap';
          ...
          <View style={styles.card}>
            ...
            <View style={styles.priceRow}>
              <Text style={styles.price}>
                {(id ? priceFor(productIdFor(String(id))) : null) ?? `$${HEALTH_PROGRAM_PRICE_USD}`}
              </Text>
            ...
            <View style={styles.footRow}>
              ...
              <Pressable onPress={onRestore} hitSlop={10}>
                <Text style={styles.leaveText}>Restore purchases</Text>
              </Pressable>
            </View>
          </View>
        </Animated.View>
...
const styles = StyleSheet.create({
  ...
  footRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 16, paddingHorizontal: 4 },
