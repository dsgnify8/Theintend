...
import {
  HEALTH_PROGRAMS, HEALTH_PROGRAM_AUTHOR, HEALTH_PROGRAM_CONSULT_ROUTE, HEALTH_PROGRAM_PRICE_USD, type HealthProgram,
    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <Pressable onPress={() => router.push(HEALTH_PROGRAM_CONSULT_ROUTE)} hitSlop={8}>
            <Text style={styles.consultLink}>Book a personalised consultation before you buy</Text>
          </Pressable>

          <View style={styles.rule} />
          <View style={styles.countRow}>
            <Text style={styles.countText}>{HEALTH_PROGRAMS.length} programs</Text>
            <Text style={styles.countText}>${HEALTH_PROGRAM_PRICE_USD} each</Text>
          </View>
      ...
      >
        ...
        <View style={styles.cardFoot}>
          ...
          <View style={styles.priceTag}>
            <Text style={styles.priceText}>${HEALTH_PROGRAM_PRICE_USD}</Text>
          </View>
        </View>
      </Pressable>
    </Animated.View>
...
const styles = StyleSheet.create({
  ...
  consultLink: { fontSize: 13.5, lineHeight: 20, color: COLORS.pastel, marginTop: 18, textDecorationLine: 'underline' },
