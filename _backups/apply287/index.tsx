...
export default function HomeScreen() {
  ...
  const suggested = useMemo(() => {
    ...
    const h = HIGHLIGHTS[day % HIGHLIGHTS.length];
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.sessionMeta}>
                {suggested.when ? `Next available ${formatWhenLocal({ starts_at: suggested.when.toISOString() })}` : 'Next available soon'}
              </Text>
...
const styles = StyleSheet.create({
  ...
  sessionIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: 'transparent', borderWidth: 1, borderColor: COLORS.line, alignItems: 'center', justifyContent: 'center', marginRight: 14 },
