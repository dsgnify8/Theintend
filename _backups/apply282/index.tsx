  ...
  return (
    <View style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.skyBox, { paddingTop: insets.top + 14 }]}>
...
const styles = StyleSheet.create({
  ...
  skyBox: { marginHorizontal: -20, paddingHorizontal: 20, paddingBottom: 30, marginBottom: 22, overflow: 'hidden' },
  ...
  label: { fontSize: 12, letterSpacing: 1.5, color: 'rgba(255,255,255,0.8)', marginBottom: 12 },
