...
import { type AiMessage, type Conversation, conversationTitle, getConversations, sendMessage } from '@/lib/yourAi';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={8}>
        ...
        {readingPast ? (
          <Pressable style={styles.backToNew} onPress={() => { setMessages([]); setReadingPast(false); }}>
