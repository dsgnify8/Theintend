    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Row
          ...
          onLayout={onTourLayout('tour-approvals')}
        ...
        <Row
          ...
          title="Bookings"
          onLayout={onTourLayout('tour-bookings')}
        ...
        <View onLayout={onTourLayout('tour-people')}>
...
function Row({ icon, title, meta, count, onPress, onLayout }: { icon: any; title: string; meta: string; count?: string | null; onPress: () => void; onLayout?: (e: any) => void }) {
  return (
    <Pressable style={styles.row} onPress={onPress} onLayout={onLayout}>
