...
export default function ExpertPanel() {
  ...
  const { rects, onTourLayout } = useTourRects();
  ...
  return (
    <Screen router={router}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tabRow} onLayout={onTourLayout('tour-coming')}>
        ...
        <Pressable style={styles.row} onPress={() => router.push('/expert-availability')} onLayout={onTourLayout('tour-availability')}>
        ...
        <ActionRow
          ...
          onLayout={onTourLayout('tour-offerings')}
        ...
        <ActionRow
          ...
          onLayout={onTourLayout('tour-money')}
        />
      </ScrollView>
    </Screen>
  );
...
function Screen({ children, router }: { children: any; router: any }) {
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {tourOpen ? (
        <Tour steps={TOUR_STEPS} rects={rects} onDone={() => setTourOpen(false)} />
      ) : null}
    </SafeAreaView>
  );
}

function ActionRow({ icon, title, meta, onPress, onLayout }: { icon: any; title: string; meta: string; onPress: () => void; onLayout?: (e: any) => void }) {
  return (
