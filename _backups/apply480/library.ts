...
export const LIBRARY: LibraryItem[] = [
  { id: 'quiet-engine', title: 'The World of Gut Health', author: 'The Intend', type: 'E-book', color: '#6F7A6B', length: 'Guided e-book', description: 'What gut health actually means, which tests are worth doing, and how the gut connects to mood, skin, hormones and immunity.', html: require('../assets/ebooks/quiet-engine.html'), cover: require('../assets/ebooks/covers/cover-quiet-engine.jpg') },
  { id: 'hormones', title: 'A Guide to Hormonal Health', author: 'The Intend', type: 'E-book', color: '#A47B6B', length: 'Guided e-book', description: 'How the hormonal system actually works, what shifts it, and how to read your own cycle with more confidence.', html: require('../assets/ebooks/hormones.html'), cover: require('../assets/ebooks/covers/cover-hormones.jpg') },
  { id: 'longevity', title: 'Living Better and Longer', author: 'The Intend', type: 'E-book', color: '#8A7C63', length: 'Guided e-book', description: 'A grounded look at how the body ages, what genuinely slows it down, and the daily choices that carry the most weight.', html: require('../assets/ebooks/longevity.html'), cover: require('../assets/ebooks/covers/cover-longevity.jpg') },
  ...
  { id: '21-days-jung', title: '21 Days of Transformation', author: 'With the Teachings of Carl Jung', type: 'E-book', color: '#5C4632', length: '21-day journey', description: 'A three week guided journey through shadow work, individuation, dreams, and the path toward wholeness.', html: require('../assets/ebooks/21-days-jung.html') },
