...
const styles = StyleSheet.create({
  ...
  cqMark: { fontFamily: FONT_SERIF, fontSize: 44, lineHeight: 46, color: COLORS.accent, opacity: 0.18 },
  cqText: { fontFamily: FONT_ITALIC, fontSize: 19, lineHeight: 27, color: COLORS.ink, marginTop: -10 },
