...
export const SOUNDS: Sound[] = [
  { id: '40hz-gamma', title: '40 Hz Binaural Gamma Waves', purpose: 'Quiets mental noise and settles you into focus that holds', category: 'Focus', duration: '60 min', color: '#5F6B57', url: 'https://xpjtyjjbgvemwwpnxtad.supabase.co/storage/v1/object/public/sounds/40hz-gamma.mp3' },
