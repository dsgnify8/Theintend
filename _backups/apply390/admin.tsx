...
const TOUR_STEPS: TourStep[] = [
  { key: 'tour-approvals', title: 'What is waiting on you', body: 'Profile changes and new offerings from experts. The count tells you if there is anything to do.' },
  { key: 'tour-bookings', title: 'Every booking', body: 'Searchable, and the only place a booking can be cancelled when someone contacts you.' },
  { key: 'tour-people', title: 'Who is who', body: 'Find anyone who has signed up and give them the expert or admin role.' },
  { key: 'tour-money', title: 'Paying experts', body: 'What each one is owed, their bank details, and marking a payout as sent.' },
];
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Row
          ...
          targetRef={setTarget('tour-approvals')}
        ...
        <Row
          ...
          title="Bookings"
          targetRef={setTarget('tour-bookings')}
        ...
        <View ref={setTarget('tour-people')} collapsable={false}>
...
function Row({ icon, title, meta, count, onPress, targetRef }: { icon: any; title: string; meta: string; count?: string | null; onPress: () => void; targetRef?: any }) {
  return (
