...
import { Tour, useTourRects, type TourStep } from '@/components/Tour';
...
export default function ExpertPanel() {
  ...
  const { rects, setTarget, measureAll } = useTourRects();
  ...
  return (
    <Screen router={router}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View ref={setTarget('tour-coming')} collapsable={false} style={styles.tabRow}>
        ...
        <Pressable ref={setTarget('tour-availability')} style={styles.row} onPress={() => router.push('/expert-availability')}>
...
function Screen({ children, router }: { children: any; router: any }) {
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {tourOpen ? (
        <Tour steps={TOUR_STEPS} rects={rects} measureAll={measureAll} onDone={() => setTourOpen(false)} />
      ) : null}
    </SafeAreaView>
  );
}

function ActionRow({ icon, title, meta, onPress, targetRef }: { icon: any; title: string; meta: string; onPress: () => void; targetRef?: any }) {
  return (
    <Pressable ref={targetRef} style={styles.row} onPress={onPress}>
