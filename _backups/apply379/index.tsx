      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hpHead}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.featureHead}>Followed week by week</Text>
          </View>
          <Pressable onPress={() => router.push('/health-programs')} hitSlop={8}>
            <Text style={styles.hpAll}>All seven {'\u203A'}</Text>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  hpCard: { width: 208, height: 236, borderRadius: 20, overflow: 'hidden', padding: 18 },
  ...
  hpCardTitle: { fontFamily: FONT_SERIF, fontSize: 21, lineHeight: 26, color: '#FFFFFF' },
