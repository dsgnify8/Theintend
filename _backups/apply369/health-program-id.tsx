...
import {
  healthProgram, HEALTH_PROGRAM_AUTHOR, HEALTH_PROGRAM_PRICE_AED, PREVIEW_STOP,
...
(function(){
  ...
  function send(){
    ...
    last = y;
    post({ y: y, vh: window.innerHeight || 1 });
  }
  send();
        ...
        <Animated.View style={[StyleSheet.absoluteFill, styles.gate, { opacity: fade }]}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.priceRow}>
              <Text style={styles.price}>AED {HEALTH_PROGRAM_PRICE_AED}</Text>
