import {
  Animated, EASE } from '@/constants/motion'; import {   healthProgram, FONT_SERIF } from '@/constants/brand'; import { DURATION, HEALTH_PROGRAM_AUTHOR, HEALTH_PROGRAM_CONSULT_ROUTE, HEALTH_PROGRAM_PRICE_USD, PREVIEW_STOP, Pressable, StyleSheet, Text, View } from 'react-native'; import { WebView } from 'react-native-webview'; import { SafeAreaView } from 'react-native-safe-area-context'; import { Ionicons } from '@expo/vector-icons'; import { LinearGradient } from 'expo-linear-gradient'; import { Stack, useEffect, useLocalSearchParams, useRef, useRouter } from 'expo-router'; import { COLORS, useState } from 'react'; import { ActivityIndicator,
        ...
        <Animated.View style={[StyleSheet.absoluteFill, styles.gate, { opacity: fade }]}>
          ...
          <View style={styles.card}>
            ...
            <Pressable
              ...
              onPress={() => router.push(HEALTH_PROGRAM_CONSULT_ROUTE)}
              hitSlop={8}
            >
              <Text style={styles.consultText}>
                Or book a free consultation first, and {HEALTH_PROGRAM_AUTHOR.replace('Dr. ', '')} will walk you
                through it and help you get what is in it.
              </Text>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  consultRow: { marginTop: 16 },
  consultText: { fontSize: 13, lineHeight: 19, color: COLORS.accent, textAlign: 'center', textDecorationLine: 'underline' },
