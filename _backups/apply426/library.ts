...
export const LIBRARY: LibraryItem[] = [
  { id: 'quiet-engine', title: 'The Quiet Engine', author: 'The Intend', type: 'E-book', color: '#6F7A6B', length: 'Guided e-book', description: 'What gut health actually means, which tests are worth doing, and how the gut connects to mood, skin, hormones and immunity.', html: require('../assets/ebooks/quiet-engine.html'), cover: require('../assets/ebooks/covers/cover-quiet-engine.jpg') },
