...
const SCRIM = ['rgba(28,24,20,0.48)', 'rgba(28,24,20,0.30)', 'rgba(28,24,20,0.52)'];
...
const BODY = `I am here for you. Your thoughts, what you are carrying, the patterns you keep meeting, where you want to get to.
...
const styles = StyleSheet.create({
  fill: { ...StyleSheet.absoluteFillObject, backgroundColor: COLORS.ink, zIndex: 50 },
  inner: { flex: 1, justifyContent: 'center', paddingHorizontal: 30 },
  kicker: { fontSize: 11, letterSpacing: 3, color: 'rgba(255,255,255,0.65)', marginBottom: 14 },
  h1: { fontFamily: FONT_SERIF, fontSize: 34, lineHeight: 41, color: '#FFFFFF', marginBottom: 22 },
  body: { fontSize: 16, lineHeight: 26, color: 'rgba(255,255,255,0.9)' },
  caret: { fontSize: 16, color: 'rgba(255,255,255,0.9)' },
  btnWrap: { paddingHorizontal: 30, paddingBottom: 54 },
  btnSpacer: { height: 54 + 52 + 14 },
  // The app's frosted button. Ink type, because white on a light panel does
  // not carry.
  btn: { paddingVertical: 16, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.55)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', alignItems: 'center' },
