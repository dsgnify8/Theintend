    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} ref={scrollRef}
        ...
        <Row
          ...
          onLayout={onTargetLayout('tour-approvals')}
        ...
        <Row
          ...
          onLayout={onTargetLayout('tour-bookings')}
        ...
        <View ref={setTarget('tour-people')} onLayout={onTargetLayout('tour-people')} collapsable={false}>
