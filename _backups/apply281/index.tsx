...
// The photo runs behind the top of the page, not just the greeting, so the
// session card passes over it while it is still fading.
const SKY_H = Math.round(SCREEN_H * 0.62);
...
const SKY_STOPS = [0, 0.14, 0.5, 0.86, 1];
    ...
    <View style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.sky} pointerEvents="none">
          ...
          <LinearGradient colors={SKY_FADE} locations={SKY_STOPS} style={StyleSheet.absoluteFill} />
        </View>
...
const styles = StyleSheet.create({
  ...
  sky: { position: 'absolute', top: 0, left: -20, right: -20, height: SKY_H },
  hero: { paddingBottom: 30, marginBottom: 18 },
  ...
  bookImage: { width: '100%', height: 210, backgroundColor: COLORS.accentSoft },
  bookBody: { padding: 20 },
