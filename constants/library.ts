...
export const LIBRARY: LibraryItem[] = [
  { id: 'abundance-kitchen', title: 'Abundance in the Kitchen', author: 'The Intend', type: 'E-book', color: '#9A7B4F', length: 'Guided e-book', description: 'A warm, beautifully designed guide to bringing abundance, nourishment and intention into the heart of your home \u2014 the kitchen.', html: require('../assets/ebooks/abundance-kitchen.html') },
  { id: '21-days-jung', title: '21 Days of Transformation', author: 'With the Teachings of Carl Jung', type: 'E-book', color: '#5C4632', length: '21-day journey', description: 'A three-week guided journey through the core teachings of Carl Jung \u2014 shadow work, individuation, dreams, and the path toward wholeness.', pdf: require('../assets/ebooks/21-days-jung.pdf') },
