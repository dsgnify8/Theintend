...
export const STRINGS = {
  ...
  // Time-of-day greetings (Home tab)
  'greeting.morning':       { en: 'Good morning',   ar: 'صباح الخير' },
  'greeting.afternoon':     { en: 'Good afternoon', ar: 'طاب يومكِ' },
  'greeting.evening':       { en: 'Good evening',   ar: 'مساء الخير' },

  // Home tab
  'home.signinPrompt':      { en: 'Sign in or create an account to track your journey', ar: 'سجّلي دخولكِ أو أنشئي حساباً لمتابعة رحلتكِ' },
  'home.moodQ':             { en: 'How are you today?',    ar: 'كيف حالكِ اليوم؟' },
  'home.upcomingSession':   { en: 'UPCOMING SESSION',      ar: 'الجلسة القادمة' },
  'home.noSessions':        { en: 'No sessions booked yet.', ar: 'لا توجد جلسات محجوزة بعد.' },
  'home.browseUpcoming':    { en: "Browse what's coming up", ar: 'تصفّحي القادم' },
  'home.upcomingWhen':      { en: 'Upcoming {when}',       ar: 'قادمة {when}' },
  'home.upcomingSoon':      { en: 'Upcoming soon',         ar: 'قريباً' },
  'home.continueReading':   { en: 'CONTINUE READING',      ar: 'متابعة القراءة' },
  'home.pctComplete':       { en: '{pct}% complete',       ar: '{pct}٪ مكتمل' },
  'home.whatReadersLove':   { en: 'What readers are loving', ar: 'ما يحبّه القرّاء' },
  'home.fromLibraryHead':   { en: 'From the library',      ar: 'من المكتبة' },
  'home.fromLibrarySub':    { en: 'A page from the newest e-book.', ar: 'صفحة من أحدث كتاب.' },
  ...
  // Experts tab
  'experts.title':          { en: 'Experts',              ar: 'الخبيرات' },
  'experts.sub':            { en: 'Find your person.',    ar: 'اختاري من تناسبكِ.' },
  'experts.heroNote':       { en: 'Every one of them works differently. Read them properly, then choose the one you recognise something in.', ar: 'اقرأي عن كل واحدة منهنّ، ثم اختاري التي تشعرين أنها الأقرب إليكِ.' },
  'experts.empty':          { en: 'No one in this category yet.', ar: 'لا أحد في هذه الفئة بعد.' },
  'experts.all':            { en: 'All',                  ar: 'الكل' },
  'experts.seeProfile':     { en: 'See profile',          ar: 'اطّلعي على الملف' },
  // Library tab
  'lib.title':              { en: 'Library',               ar: 'المكتبة' },
  'lib.sub':                { en: 'Everything here is yours to use at your own pace.', ar: 'كل ما هنا لكِ، استعمليه على مهلكِ.' },
  'lib.practices':          { en: 'PRACTICES',             ar: 'الممارسات' },
  'lib.read':               { en: 'READ',                  ar: 'قراءة' },
  'lib.articles':           { en: 'ARTICLES',              ar: 'المقالات' },
  'lib.readingRoom':        { en: 'The reading room',      ar: 'غرفة القراءة' },
  'lib.readingLoading':     { en: 'Essays and guides from our experts.', ar: 'مقالات وأدلّة من خبيراتنا.' },
  'lib.readingCount':       { en: '{n} pieces on healing, patterns, money and the body.', ar: '{n} مقالاً حول الشفاء والأنماط والمال والجسد.' },
  'lib.enter':              { en: 'Enter',                 ar: 'ادخلي' },
  'lib.hpTitleAr':          { en: 'protocols',             ar: 'تسعة بروتوكولات' },
  'lib.hpLine':             { en: 'Structured week by week, for the things that do not resolve on their own. Written by {author}.', ar: 'مصمَّمة أسبوعاً تلو الآخر، لما لا يزول من تلقاء نفسه. من إعداد {author}.' },
  'lib.open':               { en: 'Open',                  ar: 'افتحي' },
  'lib.ebooks':             { en: 'E-books',               ar: 'الكتب الإلكترونية' },
  'lib.soundsFrequencies':  { en: 'Sounds & Frequencies',  ar: 'الأصوات والترددات' },
  'lib.seeAll':             { en: 'See all',               ar: 'شاهدي الكل' },
  'lib.workbooks':          { en: 'Workbooks',             ar: 'دفاتر العمل' },
  'lib.inProgress':         { en: 'In progress',           ar: 'قيد الإكمال' },
  'lib.resume':             { en: 'Resume',                ar: 'أكملي' },
  'lib.start':              { en: 'Start',                 ar: 'ابدئي' },
  'lib.uploadFailed':       { en: 'Upload failed',         ar: 'فشل الرفع' },
  'lib.uploadError':        { en: 'Could not save that image.', ar: 'لم نتمكن من حفظ الصورة.' },
  // Sessions tab
  'sess.oneToOne':          { en: 'One to one',            ar: 'جلسة فردية' },
  'sess.programs':          { en: 'Programs',              ar: 'برامج' },
  'sess.title':             { en: 'Sessions',              ar: 'جلسات' },
  'sess.sub':               { en: 'One to one sessions and guided programs with your experts.', ar: 'جلسات فردية وبرامج موجَّهة مع خبيراتكِ.' },
  'sess.noPrograms':        { en: 'No programs match these filters yet.', ar: 'لا توجد برامج تطابق هذه الفلاتر بعد.' },
  'sess.withPrefix':        { en: 'with ',                 ar: 'مع ' },
  'sess.free':              { en: 'FREE',                  ar: 'مجاناً' },
  'sess.nSessions':         { en: '{n} sessions',          ar: '{n} جلسات' },
  'sess.nWeeks':            { en: '{n} weeks',             ar: '{n} أسابيع' },

  // Filter sheet
  'filter.programs':        { en: 'Filter programs',       ar: 'تصفية البرامج' },
  'filter.categories':      { en: 'Categories',            ar: 'الفئات' },
