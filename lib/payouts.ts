...
// How many held sessions have not been paid for, across everyone. Counted in
// the database rather than by loading every booking and working out earnings,
// which is what the payouts screen does and is far too much for a badge.
